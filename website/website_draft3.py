...
def home():
    ...
    professor_banner = """
    <div style="background-color: #e8f4f8; padding: 20px; border-radius: 10px; margin-bottom: 20px; text-align: center;">
        <h2 style="color: #034f84; font-weight: bold; font-size: 2em;">“Imagine knowing what's in your food using your phone”</h2>
        <p style="color: #034f84; font-size: 1.2em; font-weight: bold; margin-top: -10px;">Thomas Theis</p>
        <a href="https://chemistry.sciences.ncsu.edu/people/ttheis/" target="_blank" 
           style="font-size: 1em; color: #034f84; text-decoration: underline;">
